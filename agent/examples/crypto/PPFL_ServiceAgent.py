...
class PPFL_ServiceAgent(Agent):
    ...
    def receiveMessage(self, currentTime, msg):
        ...
        if msg.body['msg'] == "CLIENT_WEIGHTS":
            ...
            if dt_combine_complete is not None: self.elapsed_time[
                'COMBINE_MODEL'] += dt_combine_complete - dt_store_complete
        ...
        if (self.current_iteration < self.no_of_iterations):
            ...
            for sender in self.received.keys():
                ...
                self.sendMessage(sender,
                                 Message({"msg": "SHARED_WEIGHTS", "sender": self.id, "weights": deepcopy(totals)}))
